...
char prompt[100];
int count = 0;
char history[MAX_HISTORY_COUNT][MAX_CMD_LENGTH];
int h_count = 0;



//this function is used for Ctrl + C command
...
//this function is used to add the history
void add_history(char *str) 
{
    if (h_count == MAX_HISTORY_COUNT) 
    {
        // this function moves the old commands to the left for make space for next commands
...
//this function is used to display history
void show_history() 
{
